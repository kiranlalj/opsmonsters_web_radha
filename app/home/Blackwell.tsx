...
export default function Blackwell() {
  ...
  return (
    <>
      <Cursor />
      <section id="blackwell-section" className="relative flex items-center justify-center h-screen w-full overflow-hidden cursor-section cursor-none">
        <div id="blackwell-bg" className="absolute inset-0">
          <Image
        ...
        <div className="relative z-10 flex flex-col justify-between h-full w-full p-10 md:p-20">
          ...
          <div className="text-center">
            ...
            <p className="text-[16px] font-mono text-white mt-2 opacity-90">Automotive Digital Transformation</p>
          </div>
