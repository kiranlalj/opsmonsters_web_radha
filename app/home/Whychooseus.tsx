...
export default function Whychooseus() {
  ...
  return (
      <section id="Whychooseus_section" className="relative bg-white text-white/80 overflow-hidden w-full">
            <div className="w-full grid grid-cols-1 lg:grid-cols-12 gap-12 px-6 md:px-12 xl:px-32 py-40 relative">
              ...
              <div className="col-span-2 flex flex-col space-y-6">
                ...
                <div className="flex flex-row md:flex-col">
                  <p className="text-black/60 uppercase tracking-[0.25em] text-base md:text-xs  mt-0 md:mt-10">
                    Why choose us
                  </p>
      
                  <div className="hidden sm:block mt-2 w-35 h-5 bg-black/30" />
              ...
              <div className="col-span-8 flex flex-col space-y-10">
                ...
                <h1 id="Whychooseus_title"
                  className="text-[52px] md:text-[80px] xl:text-[90px] font-semibold leading-[1.05] text-black/50">
                   Designed to Make<br /> Your Life Easier
                </h1>
      
                <p id="Whychooseus_subtitle"
                  className="text-lg md:text-xl xl:text-2xl text-black/60 max-w-3xl leading-relaxed">
                  <span className="inline-block w-12 h-px bg-black/30 mr-4 mb-1 align-middle" />
